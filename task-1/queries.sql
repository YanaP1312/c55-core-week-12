...
VALUES ('Yana', 'Pechenenko', 'Ukrainian', 1994);
...
VALUES ('Letting go', 2023, "Novel", 25);
...
DELETE FROM books
WHERE title = "Letting go" AND author_id = 25;
...
SELECT genre, COUNT(title) AS count FROM books
GROUP BY genre
ORDER BY count DESC;
